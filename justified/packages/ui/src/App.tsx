            ...
            <div className="mx-auto max-w-3xl space-y-12 md:space-y-16">
              ...
              <section id="shadows" className="py-6 md:py-8 space-y-6">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    ...
                    <code className="bg-muted px-1 py-0.5 rounded text-xs">src/index.css</code> to rebrand.
                  </p>
                </div>
                <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                  {[
                    ...
                    <div key={s.id} className="space-y-2 rounded-lg p-4">
                      ...
                      <div className={`h-20 rounded-md bg-muted/50 ${s.token === "shadow-brand" ? "shadow-brand" : s.token}`} />
                    </div>
                  ))}
                </div>
              </section>
              ...
              <section id="inputs" className="py-6 md:py-8 space-y-6">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    Input states: default, placeholder, focus, hover, disabled, error, and read-only. Use{" "}
                    <code className="bg-muted px-1 py-0.5 rounded text-xs">error</code> or{" "}
                    <code className="bg-muted px-1 py-0.5 rounded text-xs">readOnly</code> for forms.
                  </p>
                </div>

...
>(({ side = "left", variant = "sidebar", collapsible = "offcanvas", className, children, ...props }, ref) => {
  ...
  if (collapsible === "none") {
    return (
      <div
        className={cn(
          "flex h-screen flex-col bg-sidebar text-sidebar-foreground border-r border-sidebar-border",
  ...
  return (
    <div
      ...
      style={isCollapsed && isOffcanvas ? { width: 0 } : undefined}
      {...props}
    >
      {children}
    </div>
...
const SidebarInset = React.forwardRef<HTMLDivElement, React.ComponentProps<"main">>(({ className, ...props }, ref) => {
  return <main ref={ref} className={cn("relative flex min-h-screen flex-1 flex-col bg-background overflow-auto", className)} {...props} />;
});
